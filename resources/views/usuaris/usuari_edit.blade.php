        ...
        <div class="card-body">
            ...
            <form class="float-right" action=" {{ action([App\Http\Controllers\UsuariController::class,'update'],['usuari' => $usuari->id]) }}" method="POST">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-11">
                        <input type="text" class="form-control" id="correu" name="correu" value="{{ $usuari->correu }}">
                    </div>
                </div>
                <div class="mb-3 row">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-11">
                        <input type="textarea" class="form-control" id="cognom" name="cognom" value="{{ $usuari->cognom }}">
                    </div>
                </div>
                <div class="mb-3 row">
